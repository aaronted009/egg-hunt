    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
            ...
            <div className="w-1/6 rounded-[15] bg-white flex flex-col p-5 shadow-lg my-10">
                <div className="flex flex-row justify-between"><span> Score:</span> <span className="text-2xl font-bold mb-2 text-(--accent-color)">{score}</span></div>
                <div className="flex flex-row justify-between"><span>Time taken:</span> <span className="text-2xl font-bold mb-2 text-(--accent-color)">{timeTaken}</span></div>
            </div>
