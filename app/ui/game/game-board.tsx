...
export default function GameBoard({ onGameCellClick, handleCellClick, gameOver, score }: { onGameCellClick: () => void, handleCellClick: (item: string) => void, gameOver: boolean, score: number }) {
